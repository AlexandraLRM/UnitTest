...
class TestLogin(unittest.TestCase):
    ...
    def test_login_button_is_displayed(self):
        ...
        self.assertTrue(self.driver.find_element(By.CLASS_NAME, "radius"), "Login button is not dispalyed")
    ...
    def test_invalid_login_message_text(self):
        self.driver.find_element(By.ID, "username").send_keys("Alexandra")
